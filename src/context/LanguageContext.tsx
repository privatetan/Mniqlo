...
export const translations: Translations = {
    ...
    'filters.sheet_title': { zh: '筛选与排序', en: 'Filters & Sort' },
    'filters.category': { zh: '分类', en: 'Category' },
    'filters.keyword': { zh: '关键词', en: 'Keyword' },
    'filters.sort': { zh: '排序', en: 'Sort' },
    'filters.results': { zh: '{n} 个结果', en: '{n} results' },
    'filters.reset': { zh: '重置', en: 'Reset' },
    'filters.done': { zh: '完成', en: 'Done' },
    'filters.summary_none': { zh: '全部分类 · 默认排序', en: 'All categories · Default sort' },
    'filters.active_count': { zh: '已启用 {n} 项', en: '{n} active' },
