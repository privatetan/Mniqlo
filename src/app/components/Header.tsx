            ...
            <div className="flex items-center gap-4">
                {pathname !== '/admin/users' && (
                    <span
                        ...
                        className="text-sm font-medium text-[#0b5fff] hover:bg-blue-50 px-3 py-1.5 rounded-lg transition-all flex items-center gap-1.5"
                    >
                ...
                <span
                    ...
                    className="text-sm text-gray-400 hover:text-red-500 hover:bg-red-50 px-2 py-1.5 rounded-lg transition-all"
                >
                    退出
                </span>
            </div>
